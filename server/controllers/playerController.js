...
const playerBasicInfoUpdate = async (req, res) => {
    try {
        const userId = req.user._id;
        const { fullName, dateOfBirth, age, gender, phone, occupation, address, yearsPlaying, hoursPerWeek } = req.body;
        ...
        player.yearsPlaying = yearsPlaying;
        player.hoursPerWeek = hoursPerWeek;
