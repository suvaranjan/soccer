...
const getTeam = async (req, res) => {
    ...
    try {
        ...
        const team = await Team.findById(teamId)
            ...
            .populate({
                path: 'players',
                select: 'fullName avatar user', // Include 'user' field to access userName if available
                populate: {
                    path: 'user',
                    select: 'userName',
...
module.exports = {
    createTeam, addPlayerToTeam, getTeam, updateTeamInfo, removePlayerFromTeam, sendTeamInvitation, getAllTeams, getTeamsBySearch, checkTeamBelongsToManager, getTeamJoinRequests, TeamJoinRequestAccept, TeamJoinRequestReject
};
