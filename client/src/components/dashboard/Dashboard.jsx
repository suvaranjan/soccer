...
import addPlayersImage from "../../Images/add-players.png";
import addTeamImage from "../../Images/add-team.png";
import playerImage from "../../Images/dashboard-player.png";
        ...
        >
          ...
          <Box display="flex">
            <Grid templateColumns="repeat(1, 1fr)" gap={1}>
              <Image src={addTeamImage} onClick={handleCreateTeam} />
              <Image src={addPlayersImage} onClick={handleAddPlayerTeam} />
            </Grid>
          </Box>
        </Box>
