...
const BasicInfoSchema = Yup.object().shape({
  ...
  coach: Yup.object().shape({
    fullName: Yup.string().required("Coach name is required"),
  ...
  sponsor: Yup.object().shape({
    ...
    contact: Yup.string().required("Sponsor contact is required"),
    amount: Yup.string().required("Sponsor amount is required"),
    period: Yup.string().required("Sponsor period is required"),
  }),
    ...
    >
      <Formik
        initialValues={{
          ...
          coach: {
            fullName: initialValues.coach.fullName,
            address: initialValues.coach.address,
          },
          bankInfo: {
            paynowNumber: initialValues.bankInfo.paynowNumber,
            bankCardNumber: initialValues.bankInfo.bankCardNumber,
            bankNumber: initialValues.bankInfo.bankNumber,
          },
          sponsor: {
            name: initialValues.sponsor.name,
            contact: initialValues.sponsor.contact,
            amount: initialValues.sponsor.amount,
            period: initialValues.sponsor.period,
          },
          formation: initialValues.formation || "3-3-4", // Default formation value
        }}
          ...
          <Form>
            ...
            <Box className="childBox">
              ...
              <Field name="sponsor.period">
                {({ field }) => (
                  <Input {...field} placeholder="Period" mb=".5rem" />
                )}
              </Field>
              <ErrorMessage
                name="sponsor.period"
